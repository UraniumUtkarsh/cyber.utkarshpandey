...
{/* glow blobs */}
  ...
  <div className="relative z-10 max-w-6xl mx-auto py-32 px-6 grid md:grid-cols-2 gap-16 items-center">
    ...
    <div>
      ...
      <p className="mt-6 text-slate-300 max-w-xl">
        I investigate network traffic, analyze cyber threats,
        perform digital forensics and build secure systems.
      </p>
      ...
      <section className="bg-white py-24">
        <div className="max-w-6xl mx-auto px-6">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
            {["Network Security","Wireshark Analysis","Nmap","OSINT","Digital Forensics","Linux","Vulnerability Scanning","Web Security"].map(skill=>(
              <div key={skill} className="p-6 bg-white rounded-2xl shadow-sm hover:shadow-lg hover:-translate-y-1 transition">
                {skill}
              </div>
            ))}
          </div>
  ...
  <p className="text-cyan-400 text-sm mt-3">
    View Report →
            ...
            <div className="border p-6 rounded-xl">
              ...
              <p className="text-gray-500 mt-2">Autonomous logic + optimization.</p>
            </div>
          </div>
        </div>
      </section>
      ...
      {/* CERTIFICATIONS */}
<section className="bg-slate-950 text-white py-24 border-t border-cyan-500/20">
  <div className="max-w-6xl mx-auto px-6">
    ...
    <div className="grid md:grid-cols-3 gap-6">
      ...
      {/* Cert 1 */}
      <div className="bg-white/5 backdrop-blur border border-cyan-400/20 p-6 rounded-2xl hover:border-cyan-400 transition">
        <p className="text-cyan-400 text-sm mb-2">Forage</p>
        <h3 className="font-semibold">
          Cybersecurity Management Job Simulation – ANZ
        </h3>
        <p className="text-slate-400 text-sm mt-2">
          Threat analysis, risk assessment, incident response, governance.
        </p>
      </div>

      {/* Cert 2 */}
      <div className="bg-white/5 backdrop-blur border border-cyan-400/20 p-6 rounded-2xl hover:border-cyan-400 transition">
        <p className="text-cyan-400 text-sm mb-2">MOOC</p>
        <h3 className="font-semibold">
          Digital Forensics Fundamentals
        </h3>
        <p className="text-slate-400 text-sm mt-2">
          Reactive & proactive investigation approaches, evidence handling.
        </p>
      </div>

      {/* Cert 3 */}
      <div className="bg-white/5 backdrop-blur border border-cyan-400/20 p-6 rounded-2xl hover:border-cyan-400 transition">
        <p className="text-cyan-400 text-sm mb-2">Event Training</p>
        <h3 className="font-semibold">
          Cyber Forensics & Cloud Security Workshop
        </h3>
        <p className="text-slate-400 text-sm mt-2">
          Exposure to forensic workflows, cloud threat models and SOC mindset.
        </p>
      </div>
...
<section className="relative py-28 bg-gradient-to-br from-slate-950 via-indigo-950 to-slate-950 text-white overflow-hidden">
  ...
  <div className="relative max-w-4xl mx-auto text-center px-6">
    ...
    <p className="mt-6 text-slate-300 text-lg">
      I actively research cyber threats, publish writeups and build security tools.
    ...
    >
      ...
      <section className="bg-indigo-600 text-white py-24 text-center">
        <h2 className="text-3xl font-bold">
          Read My Cybersecurity Writeups
        </h2>

        <Link href="/blogs" className="inline-block mt-6 px-8 py-3 bg-white text-indigo-600 rounded-xl">
          Go to Blogs
        </Link>
      </section>
