...
<section className="bg-slate-950 text-white py-24">
  <div className="max-w-6xl mx-auto px-6">
    ...
    <p className="text-slate-400 mb-10">
      Practical tools for real-world cybersecurity analysis and threat detection.
    </p>
    ...
    <div className="grid md:grid-cols-3 gap-6">
      ...
      {/* TOOL 1 */}
      <Link href="/tools">
        <div className="group cursor-pointer border border-cyan-400/20 bg-white/5 backdrop-blur rounded-xl p-6 hover:border-cyan-400 hover:shadow-lg hover:shadow-cyan-500/20 transition">
          ...
          <p className="text-sm text-slate-300">
            Scan suspicious URLs using VirusTotal API.
          </p>
      ...
      {/* TOOL 2 */}
      <Link href="/tools">
        <div className="group cursor-pointer border border-indigo-400/20 bg-white/5 backdrop-blur rounded-xl p-6 hover:border-indigo-400 hover:shadow-lg hover:shadow-indigo-500/20 transition">
          ...
          <p className="text-sm text-slate-300">
            Create plus-address emails for tracking and filtering.
          </p>
      ...
      {/* TOOL 3 */}
      <Link href="/tools">
        <div className="group cursor-pointer border border-orange-400/20 bg-white/5 backdrop-blur rounded-xl p-6 hover:border-orange-400 hover:shadow-lg hover:shadow-orange-500/20 transition">
          ...
          <p className="text-sm text-slate-300">
            Detect phishing emails using AI-powered analysis.
          </p>
